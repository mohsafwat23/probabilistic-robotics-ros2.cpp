...
fiducial = [
    [0, 4, -4, 0.38, 0, -pi2, -pi2/2],
    [1, 4, -1.5, 0.38, 0, -pi2, 0],
    [2, 4, 1.5, 0.38, 0, -pi2, 0],
    [3, 4, 4, 0.38, 0, -pi2, pi2/2],
    [4, 1.5, 4, 0.38, 0, -pi2, pi2],
    [5, -1.5, 4, 0.38, 0, -pi2, pi2],
    [6, -4, -4, 0.38, 0, -pi2, (pi+pi2/2)],
    [7, -4, 1.5, 0.38, 0, -pi2, -2.0*pi2],
    [8, -4, -1.5, 0.38, 0, -pi2, -2.0*pi2],
    [9, -4, 4, 0.38, 0, -pi2, -(pi +pi2/2)],
    [10, 1.5, -4, 0.38, 0, -pi2, -pi2],
    [11, -1.5, -4, 0.38, 0, -pi2, -pi2],
]
